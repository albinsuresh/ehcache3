...
public class DefaultSizeOfEngineProviderConfigurationParserTest {
  ...
  public void parseServiceCreationConfiguration() throws SAXException, JAXBException, ParserConfigurationException, IOException {
    ...
    DefaultSizeOfEngineProviderConfigurationParser parser = new DefaultSizeOfEngineProviderConfigurationParser();
    ...
    assertThat(configuration, instanceOf(DefaultSizeOfEngineProviderConfiguration.class));
